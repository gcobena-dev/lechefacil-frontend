export default {
  ...
  lactationRevenue: "Ingresos",
  lactationRevenueNoPrice: "Sin precio registrado",
  certificateFiles: "Archivos del certificado",
  certificateFileAdd: "Agregar archivo",
  certificateFileDropHere:
    "Arrastra el certificado aquí o haz clic para seleccionarlo",
  certificateFileHint: "Imagen (JPG, PNG, HEIC) o PDF, hasta {max} MB",
  certificateNoFiles: "No hay archivos del certificado",
  certificateFileDelete: "Eliminar archivo",
  certificateFileUploaded: "Certificado subido",
  certificateFileUploadError: "No se pudo subir el certificado",
  certificateFileDeleted: "Archivo eliminado",
  certificateFileDeleteError: "No se pudo eliminar el archivo",
  certificateFileTooLarge: "El archivo supera los {max} MB",
  certificateFileUnsupported: "Formato no permitido: usa una imagen o un PDF",
  editCertificateHint:
