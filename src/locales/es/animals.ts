export default {
  ...
  animalsTitle: "Gestión de Animales",
  ...
  holstein: "Holstein",
  jersey: "Jersey",
  brownSwiss: "Pardo Suizo",
  angus: "Angus",
  brahman: "Brahman",
  mixed: "Mestizo",

  // Placeholders
  namePlaceholder: "Ej: Bessie",
  earTagPlaceholder: "Ej: 001",
  weightPlaceholder: "Ej: 450",
  ...
  // Mensajes
  animalSaved: "Animal guardado correctamente",
  animalUpdated: "Animal actualizado correctamente",
  animalDeleted: "Animal eliminado correctamente",
  deleteConfirm: "¿Estás seguro de que deseas eliminar este animal?",

  // Listado
  searchAnimals: "Buscar animales...",
  filterByStatus: "Filtrar por estado",
  sortBy: "Ordenar por",
  noAnimals: "No hay animales registrados",
  ...
  // Página principal
  title: "Animales",
  subtitle: "Gestión del ganado lechero",
  ...
  deadFilter: "Muertos",
  animalsFound: "animales encontrados",
  noAnimalsFound: "No se encontraron animales con los filtros aplicados",

  // Filtros y orden
  filterStatus: "Estado",
  filterSex: "Sexo",
  filterLabels: "Etiquetas",
  filterWithdrawal: "Resguardo de leche",
  filterLot: "Lote",
  filterBreed: "Raza",
  ...
  withdrawalActive: "En resguardo",
  withdrawalNone: "Sin resguardo",
  sortTag: "Código",
  sortName: "Nombre",
  sortBreed: "Raza",
  sortAge: "Edad",
  sortLot: "Lote",
  sortClassification: "Clasificación",
  sortToggleDirection: "Cambiar dirección de orden",
  ...
  tagNumber: "Número de Arrete",
  animalName: "Nombre del animal",
  tagExample: "Ej: 001, A123",
  breedExample: "Ej: Holstein, Jersey",
  lotExample: "Ej: A, B, C",
  lot: "Lote",
  additionalNotes: "Notas adicionales sobre el animal",
  updating: "Guardando...",
  updateAnimal: "Actualizar Animal",
  creating: "Creando...",
  createAnimal: "Crear Animal",
  animalCreatedMsg: "Animal creado",
  ...
  age: "Edad",
  birthDateDetail: "Fecha de Nacimiento",
  total90Days: "Total 90 días",
  dailyAverage: "Promedio diario",
  earnings90Days: "Ingresos 90 días",
  production: "Producción",
  health: "Salud",
  movements: "Movimientos",
  milkingRecords: "Registros de Ordeño (Últimos 90 días)",
  healthEvents: "Eventos de Salud (Últimos 90 días)",
  movementsHistory: "Historial de Movimientos",
  lactations: "Lactancias",
  events: "Eventos",
  genealogy: "Genealogía",
  noProductionRecords: "No hay registros de producción en los últimos 90 días",
  noHealthEvents: "No hay eventos de salud registrados en los últimos 90 días",
  ...
  // Genealogy & certificate sections
  genealogyInfo: "Información Genealógica",
  dam: "Madre (Dam)",
  sire: "Padre (Sire)",
  viewDam: "Ver madre",
  viewSire: "Ver padre",
  ...
  bolusId: "ID de Bolo",
  bolusIdExample: "Ej: 840003123456789",
  tattooLeft: "Tatuaje Izquierdo",
  tattooRight: "Tatuaje Derecho",
  tattooExample: "Ej: ABC123",
  issueDate: "Fecha de Emisión",
  breeder: "Criador",
  breederNamePlaceholder: "Nombre del criador",
  owner: "Propietario",
  ownerNamePlaceholder: "Nombre del propietario",
  farm: "Finca",
  ...
  sireInternal: "Toro de mi finca",
  sireExternal: "Toro externo",
  selectMethod: "Seleccionar método",
  methodAI: "Inseminación Artificial",
  methodNatural: "Monta Natural",
  methodET: "Transferencia Embrión",
  technicianNamePlaceholder: "Nombre del técnico",
  buyerNamePlaceholder: "Nombre del comprador",
  priceExample: "Ej: 1500.00",
  saleReasonPlaceholder: "Motivo de la venta",
  deathCausePlaceholder: "Causa de la muerte",
  cullReasonPlaceholder: "Motivo del descarte",
  genderRequired: "Sexo es requerido",
  calfTagRequired: "Arete de la cría es requerido",
  calfTag: "Arete de la Cría",
  calfName: "Nombre de la Cría",
  birthWeightKg: "Peso al Nacer (kg)",
  birthWeightExample: "Ej: 38.5",
  ...
  event: {
    calving: "Parto",
    calvingDesc: "Registrar un parto (abre nueva lactancia)",
    dryOff: "Secar",
    dryOffDesc: "Secar al animal (cierra lactancia)",
    service: "Servicio",
    serviceDesc: "Registrar servicio o monta",
    birth: "Nacimiento",
    birthDesc: "Registrar nacimiento de cría",
    sale: "Venta",
    saleDesc: "Registrar venta del animal",
    death: "Muerte",
    deathDesc: "Registrar muerte del animal",
    cull: "Descarte",
    cullDesc: "Registrar descarte del animal",
    embryoTransfer: "Transferencia Embrión",
    embryoTransferDesc: "Registrar transferencia de embrión",
    abortion: "Aborto",
    abortionDesc: "Registrar aborto",
    transfer: "Traslado",
    transferDesc: "Registrar cambio de lote",
  },

  // Toasts
  certificateCreated: "Certificado creado exitosamente",
  certificateCreateError: "Error al crear certificado",
  certificateUpdated: "Certificado actualizado exitosamente",
  certificateUpdateError: "Error al actualizar certificado",
  certificateDeleted: "Certificado eliminado exitosamente",
  certificateDeleteError: "Error al eliminar certificado",
  eventRegistered: "Evento registrado exitosamente",
  eventRegisterError: "Error al registrar evento",
};
