export default {
  ...
  // Edición de producción / entregas
  editProduction: "Editar producción",
  editDelivery: "Editar entrega",
  editProductionTitle: "Editar registro de producción",
  editDeliveryTitle: "Editar registro de entrega",
  editProductionDescription: "Modifica la cantidad y las notas del registro.",
  editDeliveryDescription: "Modifica el volumen y las notas de la entrega.",
  productionUpdated: "Producción actualizada",
  productionUpdatedDescription: "El registro se actualizó correctamente.",
  deliveryUpdated: "Entrega actualizada",
  deliveryUpdatedDescription: "La entrega se actualizó correctamente.",
  couldNotUpdateProduction: "No se pudo actualizar la producción",
  couldNotUpdateDelivery: "No se pudo actualizar la entrega",
